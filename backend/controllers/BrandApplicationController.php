...
use backend\models\BrandApplicationSearch;
...
class BrandApplicationController extends Controller
{
    ...
    /**
     * Lists all BrandApplication models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new BrandApplicationSearch();
    ...
    /**
     * Displays a single BrandApplication model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing BrandApplication model.
    ...
    /**
     * Deletes an existing BrandApplication model.
