...
class UsersSearch extends Users
{
    ...
    {
        return [
            [['user_id', 'sex', 'pay_points', 'rank_points', 'address_id', 'zone_id', 'reg_time', 'last_login', 'visit_count', 'user_rank', 'is_special', 'parent_id', 'flag', 'is_validated', 'servicer_user_id', 'servicer_info_id', 'bank_info_id'], 'integer'],
            [['email', 'user_name', 'password', 'question', 'answer', 'birthday', 'last_time', 'last_ip', 'ec_salt', 'salt', 'alias', 'msn', 'qq', 'office_phone', 'home_phone', 'mobile_phone', 'company_name', 'passwd_question', 'passwd_answer', 'headimgurl', 'openid', 'qq_open_id', 'aite_id', 'unionid', 'wx_pc_openid', 'licence_image', 'brand_id_list', 'auth_key', 'access_token', 'channel'], 'safe'],
