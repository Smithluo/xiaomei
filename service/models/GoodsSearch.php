...
/**
 * GoodsSearch represents the model behind the search form about `service\models\Goods`.
 */
class GoodsSearch extends Goods
{
    ...
    public function rules()
    {
        return [
            ...
            [['goods_sn', 'goods_name', 'goods_name_style', 'provider_name', 'measure_unit', 'keywords', 'goods_brief', 'goods_desc', 'goods_thumb', 'goods_img', 'original_img', 'extension_code', 'seller_note', 'children', 'shelf_life'], 'safe'],
