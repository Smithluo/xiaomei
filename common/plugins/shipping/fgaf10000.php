...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式插件的代码必须和文件名保持一致 */
    $modules[$i]['code']    = 'fgaf10000';

    $modules[$i]['version'] = '1.0.0';

    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'fgaf10000_desc';
...
class fgaf10000
{
    ...
    //  构造函数 ——分配数据
    public function fgaf10000($cfg=array())
    {
    ...
    public function calculate($goods_weight, $goods_amount, $goods_number)
    {
        ...
        Yii::warning(' fgaf10000 运费 $shippingFee = '.$shippingFee, __METHOD__);
        return $shippingFee;
    }
    ...
    {
        Yii::warning(' fgaf10000 计算运费开始  $goods_amount = '.$goods_amount, __METHOD__);
