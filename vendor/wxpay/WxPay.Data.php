...
class WxPayDataBase
{
	...
	**/
	...
	{
		$sign = $this->MakeSign();
		\Yii::info("WxPay SetSign sign = ". $sign, __METHOD__);
...
{	
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetAppid value = ". $value, __METHOD__);
	...
	**/
	...
	{
		$retVal = $this->values['appid'];
		\Yii::info("WxPayUnifiedOrder GetAppid", __METHOD__);
		return $retVal;
	}
	/**
	* 判断微信分配的公众账号ID是否存在
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetMch_id value = ". $value, __METHOD__);
	...
	**/
	...
	{
		$retVal = $this->values['mch_id'];
		\Yii::info("WxPayUnifiedOrder GetMch_id value = ". $retVal, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetDevice_info value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetNonce_str value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetBody value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetDetail value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetAttach value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetOut_trade_no value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetTotal_fee value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetTime_start value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetTime_expire value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetGoods_tag value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetNotify_url value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetTrade_type value = ". $value, __METHOD__);
	...
	**/
	...
	{
		\Yii::info("WxPayUnifiedOrder SetOpenid value = ". $value, __METHOD__);
