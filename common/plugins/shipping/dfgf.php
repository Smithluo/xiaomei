...
class dfgf
{
    ...
    //  构造函数 ——分配数据
    public function dfgf($cfg=array())
    {
    ...
    {
        Yii::warning(' dfgf 全国包邮 $goods_amount = '.$goods_amount, __METHOD__);
    ...
    public function calculateAndModify($goods_weight, $goods_amount, $goods_number, $prepay = 0)
    {
        return [
            'shipping_fee' => 0,
            'shipping_code' => 'dfgf',
            'shipping_id' => Shipping::getShippingIdByCode('dfgf'),
        ];
    }
