...
/**
 * TouchAdPositionSearch represents the model behind the search form about `common\models\TouchAdPosition`.
 */
class TouchAdPositionSearch extends TouchAdPosition
{
    /**
     * @inheritdoc
     */
