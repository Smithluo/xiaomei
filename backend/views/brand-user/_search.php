...
<div class="brand-user-search">
    ...
    <?php // echo $form->field($model, 'servicer_user_id') ?>

    <?php // echo $form->field($model, 'servicer_super_id') ?>

    <?php // echo $form->field($model, 'brand_id_list') ?>
    ...
    <?php // echo $form->field($model, 'bank_info_id') ?>

    <?php // echo $form->field($model, 'brand_admin_id') ?>
