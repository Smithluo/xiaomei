...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式插件的代码必须和文件名保持一致 */
    $modules[$i]['code']    = 'fgaf2500';

    $modules[$i]['version'] = '1.0.0';

    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'fgaf2500_desc';
...
class fgaf2500
{
    ...
    //  构造函数 ——分配数据
    public function fgaf2500($cfg=array())
    {
    ...
    public function calculate($goods_weight, $goods_amount, $goods_number)
    {
        ...
        Yii::warning(' fgaf2500 运费 $shippingFee = '.$shippingFee, __METHOD__);
        return $shippingFee;
    }
    ...
    {
        Yii::warning(' fgaf2500 计算运费开始  $goods_amount = '.$goods_amount, __METHOD__);
