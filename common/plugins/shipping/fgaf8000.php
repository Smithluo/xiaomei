...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式插件的代码必须和文件名保持一致 */
    $modules[$i]['code']    = 'fgaf8000';

    $modules[$i]['version'] = '1.0.0';

    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'fgaf8000_desc';
...
class fgaf8000
{
    ...
    //  构造函数 ——分配数据
    public function fgaf8000($cfg=array())
    {
    ...
    public function calculate($goods_weight, $goods_amount, $goods_number)
    {
        ...
        Yii::warning(' fgaf8000 运费 $shippingFee = '.$shippingFee, __METHOD__);
        return $shippingFee;
    }
    ...
    {
        Yii::warning(' fgaf8000 计算运费开始  $goods_amount = '.$goods_amount, __METHOD__);
