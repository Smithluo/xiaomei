...
<div class="servicer-divide-record-form">
    ...
    <?= $form->field($model, 'spec_strategy_id')->textarea(['rows' => 6]) ?>
    ...
    <?= $form->field($model, 'parent_divide_amount')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'child_record_id')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'money_in_record_id')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'servicer_user_name')->textInput(['maxlength' => true]) ?>
